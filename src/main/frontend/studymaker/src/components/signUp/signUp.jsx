...
const SignUp = () => {
  ...
  const onSubmit = (e) => {
    ...
    fetch("/api/sign-up", signup_info).then(alert("회원가입이 완료되었습니다.")).then(window.location.href = "/");
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <form onSubmit={onSubmit} className={styles.form} action="index.html" method="POST">
          <div>
